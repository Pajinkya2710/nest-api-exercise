...
/* eslint-disable prettier/prettier */
/**
 * @description - You should create a class, such as {CreateUserController}, in which a GET method returns the a single comment based on its ID. Function name and signature should follow the same scheme as
